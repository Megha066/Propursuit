  ...
  return (
    ...
    <div className="relative my-3">
      ...
      <div className='relative z-10 flex justify-center items-center min-h-screen'>
        <div className='bg-white bg-opacity-80 rounded-lg  p-10 shadow-lg w-150'>
          <div>
            <p className='libertinus-mono-regular text-center text-xl font-bold'>Hello {userData ? userData.name :'User'}</p>
            <h1 className='libertinus-mono-regular p-3 text-center text-3xl font-bold'>Welcome to Claripath</h1>
    ...
    <div className='bg-white border-2 border-white rounded-lg m-10 p-10'>
      <div className='flex justify-between items-center'>
        ...
        <div>
          <img width={500} src="./images/books.jpg" alt="books" />
        </div>
      </div>
    </div>
